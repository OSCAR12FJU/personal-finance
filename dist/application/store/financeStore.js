...
class FinanceStore {
    ...
    getTotalIngresos() {
        return Object.values(this.data).reduce((sum, month) => sum + month.totalIngresos, 0);
    }
    getTotalGastos() {
        return Object.values(this.data).reduce((sum, month) => sum + month.totalGastos, 0);
    }
    reset() {
        this.data = {};
        this.saveData();
...
//   const useFinanceStore = FinanceStore.getInstance();
// export default useFinanceStore;
//# sourceMappingURL=financeStore.js.map