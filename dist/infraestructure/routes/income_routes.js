import { handleListIncomes } from "../controllers/income_comtroller.js";
...
export const incomeRoutes = (bot) => {
    ...
    const handleDayIncome = async (ctx) => {
    ...
    const handleMonthyIncome = async (ctx) => {
...
//# sourceMappingURL=income_routes.js.map