...
import { controllerExpense, handleListExpenses } from "../controllers/expense_controller.js";
import { stateAction } from "../../application/stateAction.js";

export const expenseRoutes = (bot: Telegraf) =>{
    ...
    bot.action('expense_btn', (ctx) => ctx.reply('¿Qué tipo de gasto?', {
      ...
      const handleDayExpense = async (ctx: Context) =>{
      ...
      const handleMonthyExpense = async (ctx: Context) =>{
